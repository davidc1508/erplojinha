...
START TRANSACTION;
ALTER TABLE public."Sales" ADD "FairId" uuid;
...
CREATE INDEX "IX_Sales_FairId" ON public."Sales" ("FairId");

CREATE INDEX "IX_Fairs_Name_EventDateUtc" ON public."Fairs" ("Name", "EventDateUtc");

ALTER TABLE public."Sales" ADD CONSTRAINT "FK_Sales_Fairs_FairId" FOREIGN KEY ("FairId") REFERENCES public."Fairs" ("Id") ON DELETE RESTRICT;

INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES ('20260419163406_AddFairsAndDashboardMetrics', '10.0.4');
